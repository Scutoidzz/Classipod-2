...
class UserMusicFolderModelAdapter extends TypeAdapter<UserMusicFolderModel> {
  @override
  final typeId = 4;

  @override
  UserMusicFolderModel read(BinaryReader reader) {
    final numOfFields = reader.readByte();
    final fields = <int, dynamic>{
      for (int i = 0; i < numOfFields; i++) reader.readByte(): reader.read(),
    };
    return UserMusicFolderModel(
      folderPath: fields[0] as String,
      folderName: fields[1] as String,
    );
  }

  @override
  void write(BinaryWriter writer, UserMusicFolderModel obj) {
    writer
      ..writeByte(2)
      ..writeByte(0)
  ...
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is UserMusicFolderModelAdapter &&
          runtimeType == other.runtimeType &&
          typeId == other.typeId;
}
